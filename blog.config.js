...
const BLOG = {
  ...
  CONTACT_ZHISHIXINGQIU: process.env.NEXT_PUBLIC_CONTACT_ZHISHIXINGQIU || 'ethanliang.top', // 知识星球
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'Ethan's Share', // 站点描述，被notion中的页面描述覆盖
